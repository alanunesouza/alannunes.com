...
export const ui = {
  pt: {
    ...
    'hero.greeting': 'Olá, sou Alan Nunes',
    'hero.role': 'Senior Software Engineer no',
    'hero.company': 'Mercado Livre',
    'hero.specialty':
    ...
    'blog.allTags': 'Todos',
    'blog.noResults': 'Nenhum artigo encontrado para a busca selecionada.',
    'blog.clearSearch': 'Limpar busca',
    'post.readTime': 'min de leitura',
    'post.by': 'Por',
    'footer.rights': 'alannunes.com • Todos os direitos reservados.',
  ...
  en: {
    ...
    'hero.greeting': "Hi, I'm Alan Nunes",
    'hero.role': 'Senior Software Engineer at',
    'hero.company': 'Mercado Libre',
    'hero.specialty':
    ...
    'blog.allTags': 'All',
    'blog.noResults': 'No articles found matching your filters.',
    'blog.clearSearch': 'Clear search',
    'post.readTime': 'min read',
    'post.by': 'By',
    'footer.rights': 'alannunes.com • All rights reserved.',
